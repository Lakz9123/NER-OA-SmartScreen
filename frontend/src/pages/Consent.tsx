      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-20">
        <div className="mx-auto flex h-16 max-w-3xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-extrabold text-slate-800 tracking-tight">Consent & Privacy</h1>
          </div>
      ...
      <main className="flex-1 mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden animate-fade-in-up">
          ...
          <div className="p-8 sm:p-10 border-b border-slate-100 flex items-center space-x-5 bg-gradient-to-r from-teal-50 to-white">
            ...
            <div>
              <h2 className="text-2xl font-black text-slate-900 tracking-tight">Informed Consent</h2>
              <p className="text-sm font-medium text-slate-500 mt-1">Please read this section aloud to the patient.</p>
            </div>
          </div>
          ...
          <div className="p-8 sm:p-10 space-y-8">
            <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 text-sm font-medium leading-relaxed">
                <p className="mb-4">
                  <strong className="text-slate-900 font-bold block mb-1">1. Purpose</strong>
                  This tool uses a questionnaire and smartphone camera to assess preliminary risk for osteoarthritis (OA).
                </p>
                <p className="mb-4">
                  <strong className="text-slate-900 font-bold block mb-1">2. Not a Diagnosis</strong>
                  This is a <em className="text-teal-700 bg-teal-50 px-1 rounded">screening aid only</em>. A high risk result indicates clinical evaluation is recommended, not that you definitely have OA.
                </p>
                <p className="mb-4">
                  <strong className="text-slate-900 font-bold block mb-1">3. Data Privacy (HIPAA Ready)</strong>
                  Video captured during the movement analysis is processed entirely on this device and is <strong className="text-rose-500">never</strong> saved or uploaded. Only numerical movement features are transmitted.
                </p>
                <p>
                  <strong className="text-slate-900 font-bold block mb-1">4. Voluntary</strong>
                  You may stop the screening at any time without penalty.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 animate-fade-in-up-delay-1">
              <label className="group flex items-start space-x-4 p-5 rounded-2xl transition-all cursor-pointer bg-slate-50 border border-slate-200 hover:bg-slate-100 has-[:checked]:border-teal-500 has-[:checked]:bg-teal-50/50 has-[:checked]:shadow-md">
                ...
                <span className="text-sm font-semibold text-slate-800 leading-relaxed">
                  The patient has verbally agreed to these terms, understands the privacy policy, and wishes to proceed with the screening.
                </span>
              </label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    type="text"
                    placeholder="Type patient's full name to sign"
