  ...
  return (
    <div className="min-h-screen bg-slate-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-teal-900 via-slate-900 to-black items-center justify-center">
        ...
        <div className="relative z-10 max-w-lg px-12 text-white opacity-0 animate-fade-in-up">
          ...
          <p className="text-lg text-slate-300 leading-relaxed font-medium">
            Empowering community health workers in North Eastern India with computer vision and clinical gait analysis to detect Osteoarthritis risks early.
          </p>
          <div className="mt-12 flex space-x-6">
            <div className="flex items-center text-teal-300 text-sm font-semibold tracking-wide uppercase">
              <ShieldCheck className="h-5 w-5 mr-2" /> HIPAA Ready
            </div>
            <div className="flex items-center text-teal-300 text-sm font-semibold tracking-wide uppercase">
              <Fingerprint className="h-5 w-5 mr-2" /> Edge Processing
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 bg-slate-50 relative">
        <div className="w-full max-w-md opacity-0 animate-fade-in-up-delay-1">
          ...
          <div className="lg:hidden flex items-center space-x-3 mb-10">
            ...
            <div>
              <h2 className="text-2xl font-black text-slate-900 tracking-tight">NER-OA</h2>
              <p className="text-xs font-bold tracking-widest text-teal-600 uppercase">SmartScreen</p>
            </div>
          </div>

          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-2">Welcome Back</h2>
            <p className="text-slate-500 font-medium">Sign in to your health worker dashboard.</p>
          </div>
