  ...
  return (
    <div className="font-sans">
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="relative z-10 p-8 sm:p-12 flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-3">
                {t('welcome_back_user', 'Welcome back, {{name}}!', { name: user ? (user.full_name || user.username) : '...' })}
              </h1>
              <p className="text-teal-100 text-lg max-w-lg leading-relaxed">
                {t('pending_message_p1', 'You have')} <strong className="text-white">{pendingCount}</strong> {t('pending_message_p2', 'screenings pending upload. Continue making an impact in your community today.')}
              </p>
            </div>
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-800 mb-6">{t('quick_actions', 'Quick Actions')}</h2>
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-2">{t('patient_list', 'Patient List')}</h3>
                <p className="text-sm text-slate-500 font-medium leading-relaxed">{t('patient_list_desc', 'View all registered patients and digital reports.')}</p>
              </div>
            </div>
